...
#include <iostream>
using namespace std;
float a, b, c, solution1, solution2 = 0;
...
int main()
{
	...
	leDiscriminant = calculDiscriminant(a, b, c,solution1,solution2); // leDiscriminant est calculé dans la fonction calculDiscriminant
	afficheResultat(leDiscriminant,solution1,solution2,a,b,c); // on envoie la variable leDiscriminant à la fonction afficheResultat ainsi que les valeurs a,b et c
